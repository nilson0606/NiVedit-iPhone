...
names=['index.html','src/style.css','src/app.js','src/model.js','src/storage.js','src/i18n.js','src/export-worker.js','src/multitrack-worker.js','src/media.js','src/preview-audio.js','src/project-file.js','src/composition.js','example/example.nvproj','vendor/mediabunny.mjs','manual.html','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png','icons/icon.svg']
