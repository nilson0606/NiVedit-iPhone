...
names=['index.html','src/style.css','src/app.js','src/model.js','src/storage.js','src/i18n.js','src/export-worker.js','vendor/mediabunny.mjs','manual.html','manifest.webmanifest','icons/icon-192.png','icons/icon-512.png','icons/icon.svg']
