# NiVedit iPhone
Independent iPhone Web App, based on desktop V13 semantics. Phase 1 preview 0.1.1.
...
First phase: one source clip, portrait/landscape UI, trim, undo/redo, original audio preview, selectable 720p/1080p30 MP4 H.264/AAC export, cancel/retry, save/share, local draft, dark/light, Chinese/English, PWA shell, guide, diagnostics.
